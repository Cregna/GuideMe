...
public class ObjectPoolingManager
{
    ...
    public void ResetPool()
    {
        ...
        foreach(var item  in ObjectPoolingManager.Instance.objectPools)
        {
            if(item.Value != null)
            {
    ...
    public int CountActiveElement()
    {
        ...
        foreach(var item  in ObjectPoolingManager.Instance.objectPools)
        {
            if(item.Value != null)
            {
               count +=  item.Value.CountActiveItem();
    ...
    public void Despawnfirst(int index)
    {
        foreach(var item  in ObjectPoolingManager.Instance.objectPools)
        {
