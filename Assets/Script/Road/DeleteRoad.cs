...
public class DeleteRoad : MonoBehaviour
{
    ...
    public static void CleanRoad_god()
    {
        print("Your n is " + RoadCreationSingle.n);
        if (RoadCreationSingle.n == 4)
        {
            ...
            {
                gm.SetActive(false);
                RoadCreationSingle.n = 0;

            }
        }
        if (RoadCreationSingle.n == 3)
        {
