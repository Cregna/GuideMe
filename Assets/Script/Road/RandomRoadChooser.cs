...
public class RandomRoadChooser : MonoBehaviour
{
   ...
   public static List<RoadType> choose = new List<RoadType>();
    ...
    public void chooseNewRoad() {
        ...
        List<RoadType> obj = new List<RoadType> { new RoadType("straight", "straight", straight), new RoadType("left90", "left90", left90), new RoadType("left45", "left45", left45), new RoadType("right45", "right45", right45), new RoadType("right90", "right90", right90), new RoadType("dirt", "straight", straight), new RoadType("loop", "straight", straight), new RoadType("hole", "straight", straight), new RoadType("bridge", "straight", straight), new RoadType("straightsplit", "straight", straight), new RoadType("tramp", "straight", straight), new RoadType("right_tunnel45", "right45", right45), new RoadType("right_tunnel90", "right90", right90), new RoadType("left_tunnel45", "left45", left45), new RoadType("left_tunnel90", "left90", left90) };
